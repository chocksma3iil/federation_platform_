...
@Component({
  ...
  template: `
    <app-page-header title="Club Details"
      [breadcrumbs]="[{ label: 'Admin', path: '/admin' }, { label: 'Clubs', path: '/admin/clubs' }, { label: 'Details' }]">
    ...
    <div class="card-padded flex flex-col items-center justify-center py-20 text-center">
      ...
      <p class="text-sm text-surface-400">Club detail page — coming in the next phase.</p>
    </div>
  `,
})
